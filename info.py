...
PICS = (environ.get('PICS', 'https://i.ibb.co/P0bzcXd/photo-2025-03-21-04-35-07-7484167443141623812.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5742630242 7782885132').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5742630242 7782885132').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002506131295'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002617811642') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002279398804')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002365360144')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://pamekap444:pbHI0CpK7YyN2ZVQ@cluster0.it753.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', "")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviesrequest_ikorm')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/iCrunchKornbots')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'iCrunch_Support') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/iCtunch_owner')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '3748be26f383c02025499927424b2731121d7de1')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/+ui8GZlcFWXBjYzA1')
